...
import {validateYupSchema} from './middleware/validator'
    ...
    <div className="md:flex w-full">
      ...
      <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
        ...
        <div>
          <div className="flex -mx-3">
            <div className="w-1/2 px-3 mb-5">
              ...
              <div className="flex">
                ...
                <input type="text" name='first_name' onBlur={handleBlur} onChange={handleChange} value={values.first_name} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John" />
              </div>
            ...
            <div className="w-1/2 px-3 mb-5">
              ...
              <div className="flex">
                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg" /></div>
                <input type="text" name='last_name' onBlur={handleBlur} onChange={handleChange} value={values.last_name} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith" />
          ...
          <div className="flex -mx-3">
            <div className="w-full px-3 mb-5">
              ...
              <div className="flex">
                ...
                <input type="email" name='email' onBlur={handleBlur} onChange={handleChange} value={values.email} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com" />
              </div>
          ...
          <div className="flex -mx-3">
            <div className="w-full px-3 mb-12">
              ...
              <div className="flex">
                ...
                <input type="password" name='password' onBlur={handleBlur} onChange={handleChange} value={values.password} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
              </div>
          ...
          <div className="flex -mx-3">
            <div className="w-full px-3 mb-5">
              <button type='button' onClick={handleSubmit} className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
            </div>
          </div>
        </div>
      </div>
